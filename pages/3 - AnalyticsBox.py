...
direc = os.getcwd()
direc = f'{direc}/pages'
tickerlist = pd.read_csv(f"{direc}/appdata/tickerlist_y.csv")['SYMBOL']
# Icons and Links ###########################
ytube = f'{direc}/appdata/imgs/ytube.svg'
fbook = f'{direc}/appdata/imgs/fbook.svg'
insta = f'{direc}/appdata/imgs/insta.svg'
linkedin = f'{direc}/appdata/imgs/linkedin.svg'
ledgrblog = f'{direc}/appdata/imgs/Ledgr_Logo_F2.png'
# ################### Sidebar and Inputs###########################
...
start_1 = dt.datetime(2020, 1, 1)
end_1 = dt.datetime.now()
# ############################################################
with st.sidebar:
